...
Screen.prototype.mouseButtonDown = async function(button) {
  //console.log('mouseButtonDown before mask update', this._mouseState.buttons)
  await this._connected()
  const buttonMask = 1 << button;
  this._mouseState.buttons = this._mouseState.buttons | buttonMask;
  //console.log('mouseButtonDown after mask update this._rfbConn.pointerEvent(', this._mouseState.buttons, this._mouseState.x, this._mouseState.y)
...
Screen.prototype.mouseButtonUp = async function(button) {
  //console.log('mouseButtonUp before mask update', this._mouseState.buttons)
  await this._connected()
  const buttonMask = 1 << button;
  this._mouseState.buttons = this._mouseState.buttons & (~buttonMask)
  //console.log('mouseButtonUp after mask update this._rfbConn.pointerEvent(', this._mouseState.buttons, this._mouseState.x, this._mouseState.y)
  this._rfbConn.pointerEvent(
    this._mouseState.x,
    this._mouseState.y,
    this._mouseState.buttons
